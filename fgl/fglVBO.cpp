...
///////////////////////////////////////////////////////////////////////////
fglVBOPoolSubBlock::fglVBOPoolSubBlock(void)
{
	id = 0;
	target = 0;
	usage = 0;
...
void fglVBO::setScene(const fglREF<fglScene>& poScene)
{ 
...
{
	if ( oScene.exist() ) oScene->oVBOPool.setData(*this, pnSize, pData, pnUsage);
}
...
{ 
	if ( oScene.exist() ) oScene->oVBOPool.freeData(*this); 
}
