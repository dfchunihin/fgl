...
void fglBBox::render(void) const
{
	...
	if ( meshType==1 ) fglScene::oCurrentScene->o3DPrimitives.renderCube(getCenter(), getSize(), lnSolid, &fglScene::oCurrentScene->o3DPrimitives.oMaterial);
	else if ( meshType==2 ) fglScene::oCurrentScene->o3DPrimitives.renderSphere(getCenter(), getSize(), 2, &fglScene::oCurrentScene->o3DPrimitives.oMaterial);
}
